...
CREATE TABLE `download_info`  (
                                        ...
                                        `download_file` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '下载文件地址',
                                        `download_music_id` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '下载歌曲id',
                                        ...
                                        `download_msg` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '下载信息错误信息',
